...
AUTOWARE_CARLA_INTERFACE_SOURCE_DIR = os.environ.get(
    "AUTOWARE_CARLA_INTERFACE_SOURCE_DIR",
    "/home/a01004/autoware/src/universe/autoware_universe/simulator/autoware_carla_interface",
)
...
def generate_launch_description():
    interface_launch = IncludeLaunchDescription(
        AnyLaunchDescriptionSource(
            f"{AUTOWARE_CARLA_INTERFACE_SOURCE_DIR}/launch/autoware_carla_interface.launch.xml"
        ),
        launch_arguments={
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "sensor_mapping_file",
                default_value=f"{AUTOWARE_CARLA_INTERFACE_SOURCE_DIR}/config/sensor_mapping.yaml",
            ),
            DeclareLaunchArgument(
                "config_file",
                default_value=(
                    f"{AUTOWARE_CARLA_INTERFACE_SOURCE_DIR}/config/"
