  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_perception_msgs::msg::TrafficSignalStamped;
    is_plain =
      (
...
static size_t _TrafficSignalStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TrafficSignalStamped(full_bounded, is_plain, 0);
