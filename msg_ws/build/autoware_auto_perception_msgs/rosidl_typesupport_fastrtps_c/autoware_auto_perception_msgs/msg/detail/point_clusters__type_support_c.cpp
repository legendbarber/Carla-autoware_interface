  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_perception_msgs__msg__PointClusters;
    is_plain =
      (
      offsetof(DataType, cluster_boundary) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PointClusters__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_auto_perception_msgs__msg__PointClusters(
