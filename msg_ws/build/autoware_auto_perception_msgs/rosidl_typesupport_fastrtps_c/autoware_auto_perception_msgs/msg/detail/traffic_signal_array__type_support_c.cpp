  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_perception_msgs__msg__TrafficSignalArray;
    is_plain =
      (
...
static size_t _TrafficSignalArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_auto_perception_msgs__msg__TrafficSignalArray(
