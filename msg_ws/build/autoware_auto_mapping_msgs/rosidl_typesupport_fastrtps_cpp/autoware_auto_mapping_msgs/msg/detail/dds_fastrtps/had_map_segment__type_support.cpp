  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_mapping_msgs::msg::HADMapSegment;
    is_plain =
      (
      offsetof(DataType, preferred_primitive_id) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _HADMapSegment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HADMapSegment(full_bounded, is_plain, 0);
