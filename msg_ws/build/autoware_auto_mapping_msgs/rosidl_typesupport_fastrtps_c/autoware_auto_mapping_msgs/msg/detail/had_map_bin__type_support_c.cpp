  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_mapping_msgs__msg__HADMapBin;
    is_plain =
      (
...
static size_t _HADMapBin__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_autoware_auto_mapping_msgs__msg__HADMapBin(
